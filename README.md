...
| -------- | ----------- |
| [docs/DEVELOPER_GUIDE.md](docs/DEVELOPER_GUIDE.md) | Developer guide: API discovery, parameter contracts, unit system, data quality utilities, validation guardrails |
| [docs/API_VALIDATION.md](docs/API_VALIDATION.md) | Full payload schemas, per-parameter validation status, test coverage map |
